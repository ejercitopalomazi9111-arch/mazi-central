...
> que se anota no es "se rindió" sino **dónde costó**. Ésa es la diferencia entre
> "pantalla rota" y "pantalla confusa", y se arreglan distinto.
...
56 equipos en 9 categorías. 64 papás, de los cuales **61 traen más de un hij@** — que es lo que rompe las apps que suponen un hijo por cuenta.
...
Carlos lo precisó: *"el punto es si el EQUIPO es nuevo, no la app, porque habla de sus
estadísticas generales, no sólo de la liga"*. Se mide contra el historial completo del
equipo, no contra la liga en curso.

| Momento | Lo que se enseña |
|---|---|
| Antes de su primer partido | Es la primera vez que Coyotes de Alameda se enfrenta a otro equipo usando la app. |
| Ya con historia (pasada 2, liga NUEVA) | 5 partidos en 2 liga(s) · 0-5 |

## La tabla final · una muestra

Categoría `var-12-13`, con posición y puntaje como se pidió:
...
4294 pantallas caminadas con identidades reales del reparto. 67 hallazgos en bruto, **7 problemas distintos** (la misma cosa la encuentran muchas personas; se agrupan y se cuenta a cuánta gente le pasa, que además es lo que dice qué tan urgente es).
...
Se dice con todas sus letras para que nadie lo confunda:

- **No prueba la nube.** Corre en modo local, sin Supabase. Es a propósito: ése es el modo
  en el que la app tiene que aguantar sola. Lo de la nube se prueba con la nube.
- **No sabe si algo se ve bonito.** Mide lo que se puede medir —tamaño del dedo, desborde,
  pantalla vacía, texto invisible por color—. El juicio de si se ve caro o barato es de la
  mesa de diseño. Decir lo contrario sería vender humo.
- **No sustituye abrir la app.** Encuentra lo que se puede medir a escala; lo que se siente
  al usarla, se siente usándola.

---

Generado por `ligas-mazi/simulacro/correr.mjs`. Semilla fija: la misma corrida produce la
misma gente y los mismos partidos, así que cualquier hallazgo se puede volver a producir.