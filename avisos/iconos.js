...
const ICONOS = {
  ...
  /* ── de quién viene el aviso, cuando no viene de una materia ────────── */
  edificio: [['p',3.5,20,3.5,9.5,12,3.5,20.5,9.5,20.5,20],['l',1.8,20,22.2,20],
             ['r',10.3,14.2,3.4,5.8],['r',6.2,10.8,2.6,2.6],['r',15.2,10.8,2.6,2.6]],
  escudo:   [['p',12,2.5,20,5.4,20,12,12,21.5,4,12,4,5.4],['l',12,2.5,12,21.5]],
  personas: [['c',9,7.6,3.2],
             ['l',3.6,20.4,3.6,17.9,5,15.6,7,14.7,11,14.7,13,15.6,14.4,17.9,14.4,20.4],
             ['c',17.4,9.2,2.4],
             ['l',15.6,15,18.4,14.6,20.4,15.6,21.2,17.9,21.2,20.4]],
