...
/* Cada materia trae su dibujo y su color. El color NO es decoración: es lo que
   ...
   AQUÍ NO VA EL NOMBRE DEL MAESTRO. Lo hubo: un campo `maestro` con el nombre
   completo de siete personas reales —tres de ellas escritas de dos formas
   distintas, señal de que nadie lo estaba manteniendo—. No lo leía nada: ni la
   ficha, ni el cartel, ni una sola prueba. Eran datos personales de gente que
   no pidió aparecer, publicados en un repo público a cambio de nada.

   Si algún día hace falta decir de quién viene un aviso, se usa la materia o
   una de las entradas oficiales de abajo. El alumno del 3.1 ya sabe quién le
   da Física; internet no tiene por qué. */
const MATERIAS = [
