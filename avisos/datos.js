...
/* Cada materia trae su dibujo y su color. El color NO es decoración: es lo que
   ...
   AQUÍ NO VA EL NOMBRE DE QUIEN IMPARTE. Lo hubo, y no lo leía nadie: ni la
   ficha, ni el cartel, ni una sola prueba. Eran los nombres completos de ocho
   maestros reales publicándose en un sitio web y en un repositorio público a
   cambio de nada. La pista de que estaba muerto la daba este mismo archivo:
   tres personas aparecían escritas de dos formas distintas —unas veces con el
   segundo apellido y otras sin él—, y si alguien lo hubiera visto en pantalla
   alguna vez, se habría notado.

   Si algún día la ficha va a mostrar quién imparte, se vuelve a añadir — pero
   con el repositorio ya en privado (`DESPLIEGUE.md` · paso 4). */
const MATERIAS = [
  { id:'quimbio',   nombre:'Química y Biología III',       corto:'Química y Bio',    icono:'matraz',   color:'#3F6B45' },
  { id:'geometria', nombre:'Geometría Analítica',          corto:'Geometría',        icono:'escuadra', color:'#1E5083' },
  { id:'progra',    nombre:'Programación y BD',            corto:'Programación',     icono:'codigo',   color:'#8C2D18' },
  { id:'fisica',    nombre:'Física I enfoque STEAM',       corto:'Física',           icono:'atomo',    color:'#123A5E' },
  { id:'ingles',    nombre:'Inglés III',                   corto:'Inglés',           icono:'globo',    color:'#5D2469' },
  { id:'efisica',   nombre:'Educación Física III',         corto:'Educación Física', icono:'pelota',   color:'#3F6B45' },
  { id:'metodo',    nombre:'Metodología Inv. I STEAM',     corto:'Metodología',      icono:'lupa',     color:'#8A6516' }  /* el dorado #B98A2E medía 3.07 de contraste sobre el papel: no se leía */,
  { id:'etica',     nombre:'Humanidades III y Ética',      corto:'Humanidades',      icono:'balanza',  color:'#5D2469' },
  { id:'mtto',      nombre:'Mto. de equipo y SO',          corto:'Mantenimiento',    icono:'monitor',  color:'#1E5083' },
  { id:'tec',       nombre:'TEC III',                      corto:'TEC',              icono:'engrane',  color:'#8C2D18' },
  { id:'redes',     nombre:'Admón. y estructura de redes', corto:'Redes',            icono:'red',      color:'#123A5E' },
  { id:'steam',     nombre:'Proyecto STEAM',               corto:'Proyecto STEAM',   icono:'steam',    color:'#5D2469' },
  { id:'general',   nombre:'Aviso general',                corto:'General',          icono:'megafono', color:'#7C1D24' },
  ...
  /* ── DE QUIÉN VIENE, cuando no viene de una materia ──────────────────
     ...
     no tiene quien la imparta y pesa distinto. Por eso son entradas propias y no
     un «Aviso general» disfrazado. */
  { id:'direccion',  nombre:'Dirección',           corto:'Dirección',  icono:'edificio', color:'#7C1D24', oficial:true },
  { id:'prefectura', nombre:'Prefectura',          corto:'Prefectura', icono:'escudo',   color:'#4A4E69', oficial:true }  /* pizarra, para que no se funda con la banda de «Muy importante», que es #5A1319 */,
  { id:'sociedad',   nombre:'Sociedad de alumnos', corto:'Sociedad',   icono:'personas', color:'#123A5E', oficial:true },
];
