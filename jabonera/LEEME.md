...
> **El diseño y contra qué se comparó están en `DISENO.md`.** Hubo tres
> vueltas y las tres están escritas ahí: `stripe.com` dio la disciplina
> tipográfica, **IBM Carbon** dio una versión austera y técnica, y al final
> **las seis referencias que mandó Carlos** —Material You, Headspace y cuatro
> apps más— fijaron el registro: esquinas muy redondeadas, color saturado en
> bloques grandes y dos colores fuertes conviviendo.
>
> Pero la identidad no se copió de nadie, sale del tema. Es **jabón**: las
> manchas orgánicas del fondo son **espuma**, todo es redondo porque una
> burbuja no tiene esquinas, y el medidor de cada baño es **una probeta
> graduada** y no una barra de progreso. Tipografía **IBM Plex Sans**
> (SIL OFL 1.1), autohospedada.
...
node jabonera/pruebas-pantalla.mjs  # la pantalla · 49 comprobaciones (necesita playwright)
...
verdad y que ninguna esquina baje de 12 px.
