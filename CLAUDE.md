...
| `tienda/marca/cortar.py` + `tienda/nucleo/apertura.js` | **La apertura con logo.** Corta el logo completo en capas (cada pixel en UNA sola: al llegar todas, queda exactamente el logo) y la app lo arma al abrir: aro, cuerdas, herramientas, G-B-D, nombre por el arco y un brillo. Una vez por sesión, se salta al toque, quieta con «reducir movimiento». Hoy: El Garaje del Barbero | ✅ 11/11 |
