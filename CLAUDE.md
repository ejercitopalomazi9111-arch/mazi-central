...
| `juegos/crisol/motor.js` | **La física de CRISOL**, aparte de la pantalla. Onda de choque con ecuación de onda, sólidos que caen y flotan, campo gravitatorio por zonas y puntos, esfuerzos separados en compresión/tracción/corte, fricción, luz, compuertas lógicas con entrada y salida, y cuerdas con nudo que hacen péndulo | ✅ probada, 165/165 |
| `juegos/crisol/pruebas-pantalla.mjs` | **Los ojos de CRISOL.** Lo que Carlos reporta —«el menú se encima al suelo», «no hace scroll», «no sé cuánto zoom llevo»— NO es física: es maqueta, y ninguna prueba de motor puede verlo. Corre en un navegador de verdad a 390×844 | ✅ 39/39 |
