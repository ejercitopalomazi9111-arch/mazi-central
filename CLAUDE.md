...
| `presentaciones/` | **Cambiar cien láminas de un jalón.** Abre un `.pptx` en el teléfono y cambia fondo, letra, color, tamaño, textos e imágenes en lote, con contraste automático y deshacer. Las imágenes se suben, se buscan en fotos libres (Openverse) o se hacen y rehacen con Gemini; Paulina y Negro proponen cambios de redacción que uno elige. Botones de **Acomodar** (que el texto quepa, fotos sin estirar, márgenes, alinear, títulos en su lugar, tamaños parejos, aire). Y el **banco de imágenes**: Carlos sube sus 300, Paulina escribe qué es cada una, temas y palabras clave, él marca «lista» o «requiere cambios» (y cuáles), se buscan sin acentos, se editan en lote, se exportan a Excel y se usan en las láminas. El banco vive en La Sala (`/banco`), no en el teléfono: Safari borra lo guardado tras 7 días sin abrir. La IA pasa por La Sala (`/ia-texto` con fotos, `/ia-imagen`), donde viven las llaves | ✅ núcleo 43/43 · pantalla 67/67 · servidor 387/387 |
