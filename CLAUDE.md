...
| `presentaciones/` | **Cambiar cien láminas de un jalón.** Abre un `.pptx` en el teléfono y cambia fondo, letra, color, tamaño, textos e imágenes en lote, con contraste automático y deshacer. Las imágenes se suben, se buscan en fotos libres (Openverse) o se hacen y rehacen con Gemini; Paulina y Negro proponen cambios de redacción que uno elige. La IA pasa por La Sala (`/ia-texto`, `/ia-imagen`), donde viven las llaves | ✅ núcleo 37/37 · pantalla 41/41 |
