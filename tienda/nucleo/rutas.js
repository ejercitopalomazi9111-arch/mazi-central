...
export const RUTAS = [
  ...
  { ruta: '/pagar',         apartado: 'cliente', titulo: 'Pagar',         icono: 'carrito',   menu: false, pantalla: 'obra',      bloque: 6,
    promesa: 'Aquí se pide quién eres, y nunca antes. Pagas ahora o al recibir.' },
  { ruta: '/pedidos',       apartado: 'cliente', titulo: 'Mis pedidos',   icono: 'pedidos',   menu: true,  pantalla: 'obra',      bloque: 6,
    promesa: 'Lo que has pedido, y «volver a pedir» en cada uno.' },
  { ruta: '/pedido/:id',    apartado: 'cliente', titulo: 'Seguimiento',   icono: 'parada',    menu: false, pantalla: 'obra',      bloque: 8,
    ejemplo: 'demo',
  ...
  { ruta: '/a/categorias',  apartado: 'admin', titulo: 'Categorías',      icono: 'categorias',menu: true,  pantalla: 'obra',      bloque: 3,
  ...
  { ruta: '/a/ajustes',     apartado: 'admin', titulo: 'Ajustes',         icono: 'ajustes',   menu: true,  pantalla: 'obra',      bloque: 3,
